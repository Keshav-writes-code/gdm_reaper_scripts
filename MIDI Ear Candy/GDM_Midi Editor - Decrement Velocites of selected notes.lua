--[[
  @description Decrement velocities of selected notes
  @about make the selected notes velocites go down like a fade out. Designed for drum hits that are very near to each other
  @version 0.1
  @license MIT
  @author GDM
  @links
